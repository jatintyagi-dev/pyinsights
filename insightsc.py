...
if df is not None:
    ...
    if ready:
        ...
        tmean = df_raw[target_variable].count()
        ...
        with st.beta_expander("Top 1st Important Contributor"):
            maxslice1, minslice1 = display_visuals(
                df_raw, df_trn, feats1, imp1, attr1, target_variable, tmean, cls=True)
